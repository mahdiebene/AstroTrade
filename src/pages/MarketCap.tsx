...
const MarketCap: React.FC = () => {
  ...
  const exploreColumns = [
    {
      ...
      render: (company: any) => (
        <div className="flex items-center">
          <CompanyLogo symbol={company.symbol} name={company.name} className="h-8 w-8" />
          <div className="ml-4">
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-white mb-4">Company Market Capitalization</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div className="bg-slate-800 rounded-lg p-6">
          <div className="flex items-center space-x-2 mb-2">
            ...
            <span className="text-sm font-medium text-gray-400">Total Companies</span>
          </div>
        ...
        <div className="bg-slate-800 rounded-lg p-6">
          ...
          <div className="text-sm text-green-400">+{topGainer?.changePercent.toFixed(2)}%</div>
        </div>
        ...
        <div className="bg-slate-800 rounded-lg p-6">
          ...
          <div className="text-sm text-red-400">{topLoser?.changePercent.toFixed(2)}%</div>
        </div>
      ...
      <div className="bg-slate-800 rounded-lg overflow-hidden mb-8">
        <div className="px-6 py-4 border-b border-slate-700">
          <h2 className="text-xl font-semibold text-white">Top Companies by Market Cap</h2>
        </div>
