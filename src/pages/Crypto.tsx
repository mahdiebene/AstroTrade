    ...
    },
    {
      ...
      render: (crypto: any) => (
        <div className="flex items-center">
          <CryptoIcon symbol={crypto.symbol} className="h-6 w-6 sm:h-8 sm:w-8" />
          <div className="ml-2 sm:ml-4 min-w-0">
            <div className="text-sm font-medium text-white truncate">{crypto.name}</div>
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
      ...
      <div className="mb-6 sm:mb-8">
        <h1 className="text-2xl sm:text-3xl font-bold text-white mb-3 sm:mb-4">Cryptocurrency Prices</h1>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 mb-6 sm:mb-8">
        <div className="bg-slate-800 rounded-lg p-3 sm:p-6">
          <div className="flex items-center space-x-2 mb-2">
            <Bitcoin className="h-4 w-4 sm:h-5 sm:w-5 text-blue-400" />
            <span className="text-xs sm:text-sm font-medium text-gray-400">Total Cryptos</span>
          </div>
        ...
        <div className="bg-slate-800 rounded-lg p-3 sm:p-6">
          <div className="flex items-center space-x-2 mb-2">
            ...
            <span className="text-xs sm:text-sm font-medium text-gray-400">Total Market Cap</span>
          </div>
          <div className="text-lg sm:text-2xl font-bold text-white">{formatNumber(totalMarketCap)}</div>
        </div>
      ...
      <div className="bg-slate-800 rounded-lg overflow-hidden mb-6 sm:mb-8">
        <div className="px-4 sm:px-6 py-4 border-b border-slate-700">
          <h2 className="text-lg sm:text-xl font-semibold text-white">Top Cryptocurrencies</h2>
        </div>
