    ...
    return (
      <div className={`bg-slate-800 rounded-lg p-6 ${className}`}>
        <button
          ...
          className="w-full flex items-center justify-between text-left hover:bg-slate-700 p-4 rounded-lg transition-colors"
        >
          <div>
            <h3 className="text-lg font-semibold text-white">{title}</h3>
            <p className="text-gray-400 text-sm">View all {data.length} items with advanced filtering and sorting</p>
          </div>
